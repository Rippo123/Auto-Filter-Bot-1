...
<i>Note : Dont add command delete bots in group! Otherwise, delall command wont work. Post some content in your channel before giving the connect command to the bot.</i>
